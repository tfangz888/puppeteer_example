...
const browser = puppeteer.launch({ headless: true, args: ['--no-sandbox', '--disable-setuid-sandbox', `--proxy-server=42.99.164.34:10015`] }).then(async browser => {
    ...
    await page.screenshot({path: '/tmp/1.png'});
